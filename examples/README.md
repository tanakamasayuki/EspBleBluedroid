...
103 examples for the **original ESP32** — the ESP32 SoC with Bluetooth Classic —
...
| [Hid/VendorHost](Hid/VendorHost/) | Central | HID Host for a vendor-defined device: Vendor Input in, Output and Feature out |
| [Hid/CustomClient](Hid/CustomClient/) | Central | The same by hand, over the generic GATT client: Report References read by handle |
