...
security, static-passkey and runtime-passkey MITM, and BLE bond management are
also available. Numeric Comparison and Bluetooth Classic APIs will continue to
be added test-first.
