...
| `peer/a2dp_sink` | 公開A2DP Sinkとraw Source、Core内蔵SBC decode、negotiated 16-bit PCM、stack task上のaudio callback、`update()`上のcontrol event、切断・終了 |
| `peer/a2dp_source` | 公開A2DP Sourceとraw Sink、同期PCM要求、Core内蔵SBC encode/decode、stream開始、stack/update context分離、切断・終了 |
